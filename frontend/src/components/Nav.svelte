		...
		>
			<div class="flex items-center">
				...
				<div class="hidden ml-10 space-x-8 lg:block">
					...
					<a href="/" class="text-base font-medium text-white hover:text-indigo-50"> Devices </a>

					<a href="/" class="text-base font-medium text-white hover:text-indigo-50"> Docs </a>

					<a href="/" class="text-base font-medium text-white hover:text-indigo-50"> Account </a>
				</div>
			</div>
